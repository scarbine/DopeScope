    ...
    <>
      ...
      <Form className="new-slide-form">
        ...
        <FormGroup className="image-upload-field">
          <Label for="slideImageUrl">Uploade Slide Image</Label>
          <br></br>
          <Input
            onChange={(event) => {
        ...
        <FormGroup className="slide-buttons">
          {slideId ? (
            <Button className="slide-btn" onClick={handleSave}>
              Update Slide
            </Button>
          ) : (
            <Button className="slide-btn" onClick={handleSave}>
          ...
          <Button className="slide-btn" onClick={handleCancel}>
            Cancel
          </Button>
        </FormGroup>
      </Form>
